"""
Django settings for r2_database_proj project.
...
# SECRET_KEY = 'django-insecure-==nxlw1p)xsq0+%uhblay=w9#m#+jye!$ax^n9o*au&+=p!ax2'
...
INSTALLED_APPS = [
    'corsheaders', # Added at 27/05/2024
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Added on 27/05/2024
...
ROOT_URLCONF = 'r2_database_proj.urls'
